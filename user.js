	...
	(function() {
	  ...
	  GM_addStyle(".fa-ico {font-size: 20px; height: 20px; padding: 10px 30px 0 40px; width: 20px;} .product-impact {margin-bottom: 20px;}");

	  var isProductPage = /\/[dg]p\//.tes t(location.href),
